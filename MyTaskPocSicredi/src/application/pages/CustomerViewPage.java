...
public class CustomerViewPage extends AbstractPage{
	...
	private static final By LOCATOR_MODAL_DELETE 		= By.xpath("//div[@class='delete-multiple-confirmation modal fade in show']//h5[text()='Delete']");
	...
	private static final By LOCATOR_ALERT_MESSAGE_VALUE	= By.xpath("//div[@class='delete-multiple-confirmation modal fade in show']//p[@class='alert-delete-multiple']");
	private static final By LOCATOR_DELETE_RECORD 		= By.xpath("//div[@class='delete-multiple-confirmation modal fade in show']//button[@class='btn btn-danger delete-multiple-confirmation-button']");
	private static final By LOCATOR_SEARCH_ICON 		= By.xpath("//div[@class='floatR']//i[@class='el el-search']");
	private static final By LOCATOR_ACTIONS_CHECKBOX 	= By.className("select-all-none");
	private static final By LOCATOR_SEARCH_NAME 		= By.name("search");
	...
	public CustomerViewPage verifyCustomerViewPageDisplayed(){
		...
		try {
			...
			elementNotFoundException.saveScreenshot("img_",driver);
	...
	public CustomerViewPage searchByName(String value){
		LOGGER.info("Clicking on seach icon.");
		
		Button searchIcon = new Button(LOCATOR_SEARCH_ICON);
		searchIcon.click();
	...
	public CustomerViewPage checkDeleteAlertMessagePopup(String value){
		Dialog modalDelete = new Dialog(LOCATOR_MODAL_DELETE);
